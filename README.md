...
[![Deploy to GitHub Pages](https://github.com/Marcosh1515/nft_dev/actions/workflows/deploy.yml/badge.svg)](https://github.com/USERNAME/nft_dev/actions/workflows/deploy.yml)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Marcosh1515/nft_dev.git
   cd nft_dev
   ```
